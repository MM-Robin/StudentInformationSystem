...
public class AttemptsFrame {
	...
	public void displayGui() {
		...
		for (Attempt a : _data) {
			...
			_attemptsData.setValueAt(a._term, row, 2);
			/*
			if (a._term == 0) {
			...
			*/
			...
			System.out.println(a._supervisor);
			//_attemptsData.setValueAt(a._supervisor);
			_attemptsData.setValueAt(a._supervisor, row, 4);
